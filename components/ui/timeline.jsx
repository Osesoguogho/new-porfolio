...
export const Timeline = ({
  ...
  return (
    <div
      className="w-full bg-[#1d1836] font-sans md:px-10"
      ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl lg:text-6xl mb-4 text-white dark:text-white max-w-4xl font-bold">
          My Projects
        </h2>
        <p
          className="text-neutral-300 text-sm md:text-base max-w-sm">
          I have work on different projects over the years. Here are some of my personal projects
        </p>
      </div>
