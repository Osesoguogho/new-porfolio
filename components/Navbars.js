...
export const Navbar = () => {
  ...
  return (
    <div className="h-[50px] min-w-screen relative flex justify-center items-center bg-[#09122c] shadow-xl text-white top-0 sticky">
      <div className="w-full h-full flex justify-evenly  ">
        ...
        <div className="sm:flex flex-row gap-5 justify-center items-center ml-8 hidden font-semibold text-xl sm:block">
        ...
        {/* display in phones */}
        { isOpen &&
        <div className="flex flex-col absolute right-1 py-5 top-[60px] w-[120px] bg-[#020327] rounded-xl shadow-2xl  h-[120px] gap-3 justify-center items-center ml-8 sm:hidden font-semibold text-sm">
          {navComp.map((nav_items) => {
            return <NavItems key={nav_items.id} items={nav_items} />;
          })}
        </div>
